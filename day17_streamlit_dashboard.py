...
#Session State logic for generating AI responses
if st.session_state.last_ticket_id != selected_id:
    st.session_state.ai_response = ""
    st.session_state.last_ticket_id = selected_id

if st.button("Generate AI Response", key=f"generate_{selected_id}"):
    st.session_state.ai_response = generate_ai_response(selected_ticket["text"])
